...
module fft_stage_3#(
    ...
    initial begin
        $readmemh("fft/fft_stage_3/real.mem", coeff_real);
        $readmemh("fft/fft_stage_3/imag.mem", coeff_imag);
        $readmemh("fft/fft_stage_3/indice_0.mem", indice_list_in);
        $readmemh("fft/fft_stage_3/indice_1.mem", indice_list_out);
