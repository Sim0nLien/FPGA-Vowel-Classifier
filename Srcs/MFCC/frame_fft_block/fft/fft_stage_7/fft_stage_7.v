...
module fft_stage_7#(
    ...
    initial begin
        $readmemh("fft/fft_stage_7/real.mem", coeff_real);
        $readmemh("fft/fft_stage_7/imag.mem", coeff_imag);
        $readmemh("fft/fft_stage_7/indice_0.mem", indice_list_in);
        $readmemh("fft/fft_stage_7/indice_1.mem", indice_list_out);
    end
