...
module fft_stage_4#(
    ...
    initial begin
        $readmemh("fft/fft_stage_4/real.mem", coeff_real);
        $readmemh("fft/fft_stage_4/imag.mem", coeff_imag);
        $readmemh("fft/fft_stage_4/indice_0.mem", indice_list_in);
        $readmemh("fft/fft_stage_4/indice_1.mem", indice_list_out);
    end
